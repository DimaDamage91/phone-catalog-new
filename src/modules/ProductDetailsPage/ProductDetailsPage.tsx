    ...
    <div className={styles["product-details-page"]}>
      ...
      <>
        ...
        <div className={styles["product-details-page__content"]}>
          ...
          <div className={styles["product-details-page__content__first"]}>
            <div className={styles["product-details-page__content__first__first"]}>
          ...
          <div className={styles["product-details-page__content__second"]}>
